...
export const en = {
  ...
  dashboard: {
    ...
    point: 'Point',
    status: 'Status',
    confirmToBlockUser: 'Do you confirm to block this user?',
    confirmToUnblockUser: 'Do you confirm to activate this user?',
    confirmToDeleteUser: 'Do you confirm to delete this user?',
    confirmToDeleteProblem: 'Do you confirm to delete this problem?',
...
export const vi = {
  ...
  dashboard: {
    ...
    avatar: 'Ảnh',
    role: 'Phân quyền',
    recipeCount: 'Số công thức',
    rank: 'Hạng',
    point: 'Điểm',
    status: 'Trạng thái',
    confirmToBlockUser: 'Xác nhận khóa tài khoản này?',
    confirmToUnblockUser: 'Xác nhận mở khóa tài khoản này?',
    confirmToDeleteUser: 'Xác nhận xóa người dùng này?',
    confirmToDeleteProblem: 'Xác nhận xóa vấn đề này?',
    problemCode: 'Mã vấn đề',
    description: 'Mô tả',
    addNewProblem: 'Thêm loại vấn đề',
    recipe: 'Công thức',
